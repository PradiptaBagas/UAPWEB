...
function kirim() {
    let kode = document.getElementById("input_kode").value;
    let jumlah = document.getElementById("input_jumlah").value;

    let harga_barang = data(kode);
    let total_harga = parseInt(jumlah) * harga_barang;
    ...
    if (isNaN(uang)) {
        alert("uang inputan tidak valid");
        return
    }
}
